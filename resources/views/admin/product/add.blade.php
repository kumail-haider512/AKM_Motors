                    	...
                    	<div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}" autocomplete="off" placeholder="Enter Price">
                                    @error('price')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select type="text" name="make_id" id="make_id" class="form-control @error('make_id') is-invalid @enderror" autocomplete="off">
                                        ...
                                        <option value="Automatic">{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('category')
                                        <span class="invalid-feedback">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="mileage" id="mileage" class="form-control @error('mileage') is-invalid @enderror" value="{{ old('mileage') }}" autocomplete="off" placeholder="Enter Mileage">
                                    @error('mileage')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="equipment" id="equipment" rows="5" class="form-control @error('name') is-invalid @enderror" autocomplete="off">{{ old('equipment') }}</textarea>
                                    @error('equipment')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="has-search item-images mt-4 input-field">
                                        <div class="row main-item-images">
                                            <div class="col-md-3">
                                                <input type="file" name="photos[]" required class="dropify" multiple data-default-file="" data-allowed-file-extensions="jpeg jpg png">
                                                <span class=" btn btn-danger w-100 py-0" style="visibility: hidden">x</span>
                                                @error('photos')

                	...
                	<div class="row">
			            <div class="col-md-12">
			                <div class="toolbar text-right">
			                	<a class="btn btn-success add-btn">+ Add Location</a>
			                </div>
			            </div>
                	</div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" onclick="deleteAlert('{{ route('admin.location.delete', $item->id) }}')" rel="tooltip" class="btn btn-danger btn-round delete-btn" data-original-title="Delete" title="Delete">
...
<script>
    $(document).on('click','.add-btn',function(){
        $.ajax({
            type: "GET",
            url: "{{route('admin.location.loadLocation')}}",
